...
The group window now shows concentration slots above the self entry, for easier tracking. Names now use the "Small" style, and are thus smaller.

h2. Player Window

Concentration slot style and position has been altered. Effect icons have been resized and repositioned slightly. Some status icons are now in the lower right corner. The window overall is much smaller. Also, health and power numbers were moved on top of the corresponding progress bars.
